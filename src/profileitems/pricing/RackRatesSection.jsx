  ...
  return (
    <section style={{ marginBottom: "24px" }}>
      ...
      >
        ...
        >
          <div style={{ padding: "12px", background: "#f5f4f1", fontWeight: 600, fontSize: "13px", color: "#1a1917" }}>
            Duration
          </div>
          <div style={{ padding: "12px", background: "#f5f4f1", fontWeight: 600, fontSize: "13px", color: "#1a1917" }}>
            Buyout
          ...
          {DURATIONS.map(({ key, label }) => (
            <React.Fragment key={key}>
              <div style={{ padding: "12px", background: "#faf9f7", fontSize: "14px", color: "#1a1917" }}>
                {label}
              </div>
